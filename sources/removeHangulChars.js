...
export function disassembleCompleteHangulCharacter(letter) {
  ...
  const middleIndex =
    ((hangulCode - lastIndex) / NUMBER_OF_JONGSUNG) % NUMBER_OF_JUNGSUNG;
...
console.log(disassembleCompleteHangulCharacter("값"));
